...
for k, v in pairs(CContainers.BackpacksClothesBOX) do
...
for k, v in pairs(CContainers.ChestRigsClothesBOX) do
...
for k, v in pairs(CContainers.BagsClothesBOX) do
...
for k, v in pairs(CContainers.FannyPacksClothesBOX) do
...
function getRunSpeedModifierVars()
    if SandboxVars.CustomizableBackpacks.RemoveRunSpeedModifier == true then
        ...
        for k, v in pairs(CContainers.BackpacksClothesBOX and CContainers.ChestRigsClothesBOX and CContainers.BagsClothesBOX and CContainers.FannyPacksClothesBOX) do
