...
function ISSimpleEntry:setEnterFunc(func)
    self.enterFunction = func;
end

function ISSimpleEntry:addArg(name, value)
    self.args[name] = value;
end

-- Vanilla modif
function ISSimpleEntry:onCommandEntered()
    self:enterFunction(self:getValue(), self.args);
end