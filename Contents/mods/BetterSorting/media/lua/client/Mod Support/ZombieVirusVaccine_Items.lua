...
TweakItem("LabItems.CmpSyringeWithPlainVaccine","DisplayCategory","Medical");
TweakItem("LabItems.CmpSyringeReusableWithPlainVaccine","DisplayCategory","Medical");
TweakItem("LabItems.CmpSyringeWithQualityVaccine","DisplayCategory","Medical");
TweakItem("LabItems.CmpSyringeReusableWithQualityVaccine","DisplayCategory","Medical");
TweakItem("LabItems.CmpSyringeWithAdvancedVaccine","DisplayCategory","Medical");
TweakItem("LabItems.CmpSyringeReusableWithAdvancedVaccine","DisplayCategory","Medical");
TweakItem("LabItems.CmpSyringeWithCure","DisplayCategory","Medical");
TweakItem("LabItems.CmpSyringeReusableWithCure","DisplayCategory","Medical");
...
TweakItem("LabItems.CmpAlbuminPills","DisplayCategory","Medical");
