...
ISChat.languages = { "Empty Slot", "Spanish", "Russian", "Ukrainian", "German", "French", "Mandarin", "Japanese", "ASL", "Korean" }
...
ISChat.addLineInChat = function(message, tabID)
    ...
    if playerAuthor and modPlayerobj then
		if string.match(line, "Typing...") then--Hiding the Typing messages from chat log.
