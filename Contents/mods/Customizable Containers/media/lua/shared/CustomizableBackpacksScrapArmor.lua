...
for k, v in pairs(CContainers.BackpacksScrapArmor) do
...
for k, v in pairs(CContainers.FannyPacksScrapArmor) do
...
function getRunSpeedModifierVars()
    if SandboxVars.CustomizableBackpacks.RemoveRunSpeedModifier == true then
        ...
        for k, v in pairs(CContainers.BackpacksScrapArmor and CContainers.FannyPacksScrapArmor) do
