...
for k, v in pairs(CContainers.BackpacksAuthZ) do
...
for k, v in pairs(CContainers.ChestRigsAuthZ) do
...
for k, v in pairs(CContainers.BagsAuthZ) do
...
for k, v in pairs(CContainers.FannyPacksAuthZ) do
...
for k, v in pairs(CContainers.SatchelsAuthZ) do
...
function getRunSpeedModifierVars()
    if SandboxVars.CustomizableBackpacks.RemoveRunSpeedModifier == true then
        ...
        for k, v in pairs(CContainers.BackpacksAuthZ, CContainers.ChestRigsAuthZ, CContainers.BagsAuthZ, CContainers.FannyPacksAuthZ) do
