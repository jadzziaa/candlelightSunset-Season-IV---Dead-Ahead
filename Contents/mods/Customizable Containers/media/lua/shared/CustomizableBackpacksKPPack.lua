if getActivatedMods():contains("KPAP") then
else return end


function getWeightReductionVars()
for k, v in pairs(CContainers.BackpacksKPPack) do
...
for k, v in pairs(CContainers.FannyPacksKPPack) do
...
function getRunSpeedModifierVars()
    if SandboxVars.CustomizableBackpacks.RemoveRunSpeedModifier == true then
        ...
        for k, v in pairs(CContainers.BackpacksKPPack and CContainers.FannyPacksKPPack) do
