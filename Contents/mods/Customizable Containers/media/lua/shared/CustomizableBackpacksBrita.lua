...
for k, v in pairs(CContainers.BackpacksBrita) do
...
for k, v in pairs(CContainers.ChestRigsBrita) do
...
for k, v in pairs(CContainers.FannyPacksBrita) do
...
function getRunSpeedModifierVars()
    if SandboxVars.CustomizableBackpacks.RemoveRunSpeedModifier == true then
        ...
        for k, v in pairs(CContainers.BackpacksBrita and CContainers.ChestRigsBrita and CContainers.FannyPacksBrita) do
