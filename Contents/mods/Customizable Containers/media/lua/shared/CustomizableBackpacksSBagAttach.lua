...
for k, v in pairs(CContainers.BackpacksSBagAttach) do
...
for k, v in pairs(CContainers.BagsSBagAttach) do
...
function getRunSpeedModifierVars()
    if SandboxVars.CustomizableBackpacks.RemoveRunSpeedModifier == true then
        ...
        for k, v in pairs(CContainers.BackpacksSBagAttach and CContainers.BagsSBagAttach) do
