if getActivatedMods():contains("P4PumpPury") then
else return end

function getWeightReductionVars()
for k, v in pairs(CContainers.BackpacksPumpPury) do
...
for k, v in pairs(CContainers.FannyPacksPumpPury) do
...
for k, v in pairs(CContainers.BagsPumpPury) do
...
function getRunSpeedModifierVars()
    if SandboxVars.CustomizableBackpacks.RemoveRunSpeedModifier == true then
        ...
        for k, v in pairs(CContainers.BackpacksPumpPury and CContainers.BagsPumpPury and CContainers.FannyPacksPumpPury) do
