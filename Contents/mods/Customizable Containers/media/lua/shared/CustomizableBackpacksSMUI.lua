...
for k, v in pairs(CContainers.BackpacksSMUI) do
...
for k, v in pairs(CContainers.ChestRigsSMUI) do
...
for k, v in pairs(CContainers.FannyPacksSMUI) do
...
function getRunSpeedModifierVars()
    if SandboxVars.CustomizableBackpacks.RemoveRunSpeedModifier == true then
        ...
        for k, v in pairs(CContainers.BackpacksSMUI and CContainers.ChestRigsSMUI and CContainers.FannyPacksSMUI) do
