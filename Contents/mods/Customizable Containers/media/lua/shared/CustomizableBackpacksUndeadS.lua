...
for k, v in pairs(CContainers.BackpacksUndeadS) do
...
for k, v in pairs(CContainers.ChestRigsUndeadS) do
    ...
    elseif SandboxVars.CustomizableChestRigs.WeightReduction == 15 then  -- WeightReduction = Custom - Randomized
        ...
        for k, v in pairs(CContainers.FannyPacksUndeadS) do
...
for k, v in pairs(CContainers.BagsUndeadS) do
...
function getRunSpeedModifierVars()
    if SandboxVars.CustomizableBackpacks.RemoveRunSpeedModifier == true then
        ...
        for k, v in pairs(CContainers.BackpacksUndeadS and CContainers.ChestRigsUndeadS and CContainers.BagsUndeadS) do
