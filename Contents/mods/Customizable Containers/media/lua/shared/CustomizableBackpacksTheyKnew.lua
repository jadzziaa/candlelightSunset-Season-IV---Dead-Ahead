if getActivatedMods():contains("TheyKnew") or getActivatedMods():contains("TheyKn0w") then
else return end


function getWeightReductionVars()
for k, v in pairs(CContainers.SatchelsTheyKnew) do
...
function getRunSpeedModifierVars()
    if SandboxVars.CustomizableSatchels.RemoveRunSpeedModifier == true then
    else return end
        for k, v in pairs(CContainers.SatchelsTheyKnew) do
