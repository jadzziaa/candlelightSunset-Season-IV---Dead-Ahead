...
function LWB2.extractCond(player)
	local vehicle = player:getVehicle()
	if (vehicle and string.find( vehicle:getScriptName(), "84mercLWB2" )) then
...
function LWB2.activeArmor(player)
    local vehicle = player:getVehicle()
    	if (vehicle and string.find( vehicle:getScriptName(), "84mercLWB2" )) then
...
Events.OnEnterVehicle.Add(LWB2.extractCond);
Events.OnPlayerUpdate.Add(LWB2.activeArmor);