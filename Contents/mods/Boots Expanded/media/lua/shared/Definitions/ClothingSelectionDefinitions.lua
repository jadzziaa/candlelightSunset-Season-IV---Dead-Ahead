...
ClothingSelectionDefinitions.default = {
	...
	Female = {
		...
		TankTop = {
			chance = 10,
			items = {"Base.Vest_DefaultTEXTURE_TINT", "Base.Corset",},
		},
...
--
		Jacket = {
			chance = 10,
			items = {"Base.Sleveless_Jacket", "Base.Sleveless_Denim", "Base.Jacket_WhiteTINT", "Base.Jacket_WhiteTINT", "Base.Jacket_Varsity", },
		},
		
		
		
		UnderwearExtra1 = {
			items = {"Base.TightsFishnets", "Base.TightsBlackSemiTrans", "Base.TightsBlackTrans", "Base.StockingsWhite",},
		},
		
		
		Pants = {
			items = {"Base.Trousers_DefaultTEXTURE_TINT", "Base.Trousers_Denim", "Base.Trousers_Denim_Thight",  "Base.Shorts_LongDenim", "Base.Shorts_ShortDenim", "Base.Shorts_ShortFormal",},
		},
		...
		Dress = {
			chance = 10,
			items = {"Base.Dress_Short", "Base.Dress_Normal", "Base.Dress_Knees", "Base.Dress_Long", "Base.Dress_long_Straps", "Base.Dress_SmallStrapless", "Base.Dress_Straps", "Base.DressKnees_Straps", "Base.Dress_SmallStraps", "Dress_Fancy","Dress_Fancy2",},
		},
		
		Socks = {
			items = {"Base.Socks_Ankle", "Base.Socks_Long", "Base.Socks_ThighGoth",},
		},
		...
		Shoes = {
			items = {"Base.Shoes_Random", "Base.Shoes_TrainerTINT", "Base.Shoes_Strapped", "Base.Shoes_BlackBoots", "Base.Shoes_ShortBoots", "Base.Shoes_Fancy", "Base.Shoes_WorkBoots", "Base.Shoes_Hitops", "Base.Shoes_ConverseSnickers","Base.Shoes_Heels","Base.Shoes_HeelsStilletos",},
		},
	},
...
--
		...
		Shoes = {
			items = {"Base.Shoes_Random", "Base.Shoes_TrainerTINT", "Base.Shoes_ShortBoots", "Base.Shoes_Fancy", "Base.Shoes_WorkBoots", "Base.Shoes_Hitops",},
		},
	}
}
